...
public class DemoRestController {
	...
	/**
	 * 一个访问URI为/demo/printMyConfiguratioinInfo的Rest服务接口，并指定接受的请求类型为get与post。
	 * 将绑定属性文件的Info对象自动转换成为json字符串返回。
	 * @return
	 */
	 ...
	 * @return
	 */
	@RequestMapping(value="demoException",method= {RequestMethod.GET,RequestMethod.POST})
